class Combinations:
    ...
    def __getitem__(self, item):
        if item >= (len(self.products)*len(self.promotions)* len(self.customers)):
            ...
            pos_customers = item
        print('{}, {}, {}'.format(self.products[pos_products],self.promotions[pos_promotions],self.customers[pos_customers]))
...
it = iter(combinations)  #tworzymy iterator od danego obiektu  i mozna uzywac next
